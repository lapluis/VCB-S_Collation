...
| 颜色                                                         | 信息                                              |
| ------------------------------------------------------------ | ------------------------------------------------- |
| $\Large \color{#ff0000}{\blacksquare}$ 红色       | 文件后缀与容器不符                                |
| $\Large \color{#00a4ac}{\blacksquare}$ 品葱色     | 容器中含有延时非 0 的轨道                         |
| $\Large \color{#DB7093}{\blacksquare}$ 浅紫红色   | 轨道间长度相差过大                                |
| $\Large \color{#ffff00}{\blacksquare}$ 黄色       | 章节问题                                          |
| $\Large \color{#EE82EE}{\blacksquare}$ 粉紫色     | 内容物与文件名描述不符                            |
| $\Large \color{#ADFF2F}{\blacksquare}$ 亮绿色     | 文件含有二条以上音轨                              |
| $\Large \color{#FFA500}{\blacksquare}$ 橙色文字   | 色彩格式特殊                                      |
| $\Large \color{#0000ff}{\blacksquare}$ 蓝色文字   | 文件含有一条以上字幕                              |
| $\Large \color{#9400D3}{\blacksquare}$ 深紫色文字 | VFR                                               |
| $\Large \color{#808000}{\blacksquare}$ 橄榄色文字 | 帧率为 29.970 (30000/1001) 或 59.940 (60000/1001) |
| $\Large \color{#6A5ACD}{\blacksquare}$ 岩蓝色文字 | 帧率分母非 1001                                   |
| $\Large \color{#800000}{\blacksquare}$ 栗色文字   | 其他特殊帧率                                      |

### 颜色详解及对应处理方法: 错误信息

这一部分介绍 MP NG 中会出现的报错, 这些报错往往意味着整理成品中可能存在压制错误、命名错误或其他整理错误, 往往需要手动修复.

**1. $\color{#ff0000}{\blacksquare}$ 红色: 文件后缀与容器不符**
...
**2. $\color{#00a4ac}{\blacksquare}$ 品葱色: 容器中含有延时非 0 的轨道**
...
**3. $\color{#DB7093}{\blacksquare}$ 浅紫红色: 轨道间长度相差过大**
...
**4. $\color{#ffff00}{\blacksquare}$ 黄色: 章节问题**
...
**5. $\color{#EE82EE}{\blacksquare}$ 粉紫色: 内容与文件名描述不符**
...
- MP NG 还能检查压制成品的帧率, 一些特殊帧率 (区别于常见帧率**24000/1001≈23.976 fps**) 会高亮显示.
  - $\color{#9400D3}{\blacksquare}$ **深紫色**: VFR (variable frame rate), 即可变帧率, 常见于真人视频与非真人视频间杂的视频, 注意此类视频往往无法进行 RPC 检查, 为防止出错请尽量人工检查.
  - $\color{#808000}{\blacksquare}$ **橄榄色**: 帧率为 **30000/1001≈29.970 fps** 或 **60000/1001≈59.940 fps**, 常见于进行过反交错/IVTC后的视频及各种真人视频.
  - $\color{#6A5ACD}{\blacksquare}$ **岩蓝色**: 帧率分母为 1000, 如**23976/1000** 或 **29970/1000**, 这类问题是可能是由于 hevc 流、mkv 文件头或 Mediainfo 显示错误导致, 但目前尚无定论, 亦无严重影响. 原则上可以不处理, 也可自行联系总监决定是否修复.
  - $\color{#800000}{\blacksquare}$ **栗色**: 其他特殊帧率, 包括但不限于以下几种:
